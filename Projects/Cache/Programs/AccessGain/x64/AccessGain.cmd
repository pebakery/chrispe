...
echo   5] Exit
echo.
echo NOTE - in 64-bit versions of WinPE, driver signing may need to be disabled.
echo F8 (during boot) - Advanced Boot Options - Disable Driver Signature Enforcement
echo.
set choice=
