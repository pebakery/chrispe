...
echo file #:\Programs.x86\MistyPE.menu.cmd and will run it 
echo if found.
echo.
...
for %%a in (a b c d e f g h i j k l m n o p q r s t u v w x y z) do (
	IF EXIST %%a:\Programs.x86\MistyPE.menu.cmd (
	CALL %%a:\Programs.x86\MistyPE.menu.cmd
	ECHO.
	GOTO _exit
	)
)
...
cls
ECHO Couldn't find \Programs.x86\MistyPE.menu.cmd at the  
