...
IF EXIST %%a:\Programs.x64\ShortcutsNotInWim.cmd CALL %%a:\Programs.x64\ShortcutsNotInWim.cmd
IF EXIST %%a:\Programs.x64\ShortcutsCopy.cmd CALL %%a:\Programs.x64\ShortcutsCopy.cmd
IF EXIST %%a:\Programs.x64\registry.entries.cmd CALL %%a:\Programs.x64\registry.entries.cmd
IF EXIST %%a:\Programs.x64\LaunchBarX64.cmd CALL %%a:\Programs.x64\LaunchBarX64.cmd
exit
)
)
